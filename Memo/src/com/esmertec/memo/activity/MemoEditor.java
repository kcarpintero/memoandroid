...
public class MemoEditor extends Activity {
    ...
    private DatePicker.OnDateSetListener mDateSetListener =
            new DatePicker.OnDateSetListener() {
                public void dateSet(DatePicker view, int year, int monthOfYear,
                    ...
                    new TimePickerDialog(MemoEditor.this, mTimeSetListener,
                            null, cal.get(Calendar.HOUR_OF_DAY), cal
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mCursor =
                managedQuery(mURI, Constants.ALL_COLUMNS_PROJECTION, null, null);
        mCursor.first();
        ...
        ib.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent =
                        new Intent(MemoProvider.ACTION_SET_LOCATION, mURI);
                startActivity(intent);
            }
        });
        ...
        ib.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                // Intent intent = new
                // Intent(MemoProvider.ACTION_EDIT_CONTACTS, mURI);
                // startActivity(intent);
        ...
        ib.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                Intent intent =
                        new Intent(MemoProvider.ACTION_EDIT_TITLE, mURI);
                startActivity(intent);
            }
        });
        ...
        // mEditActivity = (AutoCompleteTextView)
        ...
        // });
        //
        // mTextAllContacts = (TextView)
        // findViewById(R.id.txt_all_contacts);
        //		
        // Button Addcontact = (Button)
        // findViewById(R.id.button_add_contact);
        //
        ...
        // // ContactListAdapter adapter = new
        // ContactListAdapter(cursor, this);
        // // mEditContact.setAdapter(adapter);
        //
        // mEditDesc = (EditText) findViewById(R.id.edit_desc);
        // mTextLocation = (TextView)
        ...
        // });
        //
        // Button changeLocation = (Button)
        // findViewById(R.id.set_location);
        //
    ...
    private void pushData() {
        mCursor.first();
        // mCursor.updateString(Constants.ALL_COLUMN_ACTIVITY,
        // mEditActivity
        // .getText().toString());
        // mCursor.updateString(Constants.ALL_COLUMN_CONTACT,
        // mEditContact
        // .getText().toString());
        mCursor.updateString(Constants.ALL_COLUMN_LOCATION, mTextLocation
                .getText().toString());
        mCursor.updateString(Constants.ALL_COLUMN_TITLE, mEditDesc.getText()
                .toString());
    ...
    protected void onActivityResult(int requestCode, int resultCode,
        ...
        //		
        // if (resultCode == RESULT_OK) {
        // // mTextLocation.setText(data.subSequence(0,
        // data.indexOf("@")));
        // mTextLocation.setText(data);
        // mCursor = managedQuery(mURI,
        // Constants.ALL_COLUMNS_PROJECTION,
        // null, null);
        // pushData();
        // }
    }
    ...
    static final String[] PEOPLE_PROJECTION =
            new String[] { Contacts.People._ID,
                    Contacts.People.PREFERRED_PHONE_ID, Contacts.People.TYPE,
                    Contacts.People.NUMBER, Contacts.People.LABEL,
                    Contacts.People.NAME, Contacts.People.COMPANY };
