...
public class TimeSetter extends Activity {
    ...
    private DatePicker.OnDateSetListener mDateSetListener =
            new DatePicker.OnDateSetListener() {
                public void dateSet(DatePicker view, int year, int monthOfYear,
                    ...
                    new TimePickerDialog(TimeSetter.this, mTimeSetListener,
                            TimeSetter.this.getTitle().toString(), mCalendar
                                    .get(Calendar.HOUR_OF_DAY), mCalendar
    ...
    private TimePicker.OnTimeSetListener mTimeSetListener =
            new TimePicker.OnTimeSetListener() {
                ...
                public void timeSet(TimePicker view, int hourOfday, int minute) {
                    ...
                    Cursor cursor =
                            managedQuery(mURI, new String[] { Memo.Memos.TIME,
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mDatePicker.init(mCalendar.get(Calendar.YEAR), mCalendar
                ...
                Calendar.SUNDAY, mDateSetListener);
