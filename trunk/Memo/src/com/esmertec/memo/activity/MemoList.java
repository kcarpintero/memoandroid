...
public class MemoList extends ListActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        ListAdapter adapter =
                new MemoListAdapter(this, R.layout.memo_item_layout, cursor);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (cursor.count() > 0) {
            Uri uri =
                    ContentUris.withAppendedId(getIntent().getData(), cursor
                            .getLong(Constants.ALL_COLUMN_ID));

            Intent[] specifics =
                    new Intent[] { new Intent(Intent.EDIT_ACTION, uri) };
    ...
    public boolean onOptionsItemSelected(Item item) {
        ...
        case ADD_MEMO_ITEM:
            Intent intent =
                    new Intent(Intent.INSERT_ACTION, getIntent().getData());
