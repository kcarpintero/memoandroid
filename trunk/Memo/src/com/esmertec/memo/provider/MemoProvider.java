...
public class MemoProvider extends ContentProvider {
    ...
    public static final String ACTION_SET_TIME =
            "com.esmertec.memos.action.SET_TIME";
    public static final String ACTION_SET_LOCATION =
            "com.esmertec.memos.action.SET_LOCATION";
    public static final String ACTION_EDIT_CONTACTS =
            "com.esmertec.memos.action.EDIT_CONTACTS";
    public static final String ACTION_EDIT_TITLE =
            "com.esmertec.memos.action.EDIT_TITLE";
    ...
    public Uri insert(Uri uri, ContentValues initialValues) {
        ...
        if (rowID > 0) {
            Uri newUri =
                    ContentUris.withAppendedId(Memo.Memos.CONTENT_URI, rowID);
    ...
    public boolean onCreate() {
        ...
        mDB =
                dbHelper.openDatabase(getContext(), DATABASE_NAME, null,
                        DATABASE_VERSION);
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        Cursor c =
                qb.query(mDB, projection, selection, selectionArgs, null, null,
                        orderBy);
